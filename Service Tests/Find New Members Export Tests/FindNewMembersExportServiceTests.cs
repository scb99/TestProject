...
namespace FindNewMembersExport;

public class FindNewMembersExportServiceTests
{
    private readonly Mock<ICrossCuttingExportExcelFileService> _mockExportExcelFileService = new();
    private readonly Mock<ICrossCuttingFileNameValidationService> _mockFileNameValidationService = new();
    private readonly Mock<ICrossCuttingIsValidFileNameService> _mockIsValidFileNameService = new();
